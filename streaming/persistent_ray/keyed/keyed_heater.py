...
class KafkaProducer:
    ...
    # Send message
    def produce(self, topic: str, data: dict, key: str):
        ...
        self.producer.produce(topic=topic, value=json.dumps(data).encode('UTF8'),  key=key.encode('UTF8'), callback=delivery_callback)
...
class Heater:
    ...
    def submit_temperature(self, timeInterval: int = tempInterval):
        ...
        print('Submitting measurement ', data, ' with key ', self.id)
