...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=local_fun]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=remote_fun]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=sleepy_task_hello_world]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=mini_crawl_task]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=ds]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=ray_wordcount_on_ds]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.ipynb[tags=actor]
----
====
