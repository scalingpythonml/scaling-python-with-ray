...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=local_fun]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=remote_fun]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=sleepy_task_hello_world]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=mini_crawl_task]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=ds]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=ray_wordcount_on_ds]
----
====
...
[source, python]
----
include::examples/ray/helloWorld/Ray-Ch2-Hello-Worlds.py[tags=actor]
----
====
