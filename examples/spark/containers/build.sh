...
if [ ! -f spark-3.1.2-bin-hadoop3.2.tgz ]; then
  axel https://ftp.wayne.edu/apache/spark/spark-3.1.2/spark-3.1.2-bin-hadoop3.2.tgz
fi
rm -rf spark-3.1.2-bin-hadoop-3.2
if [ ! -d spark-3.1.2-bin-hadoop3.2 ]; then
