...
.Sample Grafana dashboard for Ray
image::images/ch12/fig_12-01.png[]
...
// AU: please add example file to repo
[[ray_counters_actor]]
.Using Ray Counters inside of an actor
====
[source, python]
----
include::examples/ray_examples/enterprise/Ray-Enterprise.py[tags=ray_counters_actor]
----
====
...
[source, python]
----
include::./examples/ray/enterprise/Ray-Enterprise.py[tags=ray_counters_singleton]
----
====
...
* Be mindful ofintegration with CI/CD and observability tools.
